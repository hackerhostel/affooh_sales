...
import TemplateOverview from "./TemplateOverview.jsx";
import TemplateHistory from "./TemplateHistory.jsx";
    ...
    <div className=" bg-dashboard-bgc min-h-screen">
      <div className="flex flex-col gap-6">
        ...
        <div style={{ flex: 1 }} className="rounded-lg">
          ...
          {activeTab === "overview" && <TemplateOverview />}
          {activeTab === "history" && <TemplateHistory />}
        </div>
      </div>
    </div>
  );
